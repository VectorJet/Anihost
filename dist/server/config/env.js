...
config();
export var DeploymentEnv;
(function (DeploymentEnv) {
    DeploymentEnv["NODEJS"] = "nodejs";
    DeploymentEnv["DOCKER"] = "docker";
    DeploymentEnv["VERCEL"] = "vercel";
    DeploymentEnv["CLOUDFLARE_WORKERS"] = "cloudflare-workers";
    DeploymentEnv["RENDER"] = "render";
...
export const env = cleanEnv(process.env, {
    ...
    ANIWATCH_API_REDIS_CONN_URL: url({
        default: undefined,
        example: "rediss://default:your-secure-password@your-redis-instance-name.provider.com:6379",
